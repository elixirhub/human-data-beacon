...
@AllArgsConstructor
@NoArgsConstructor
public class BeaconPlantResponse {
  ...
  private BeaconPlantRequest PlantRequest;
  ...
  private List<DatasetPlantResponse> datasetPlantResponses;

  public void addDatasetPlantResponse(DatasetPlantResponse datasetPlantResponse) {
    if (this.datasetPlantResponses == null) {
      this.datasetPlantResponses = new ArrayList<DatasetPlantResponse>();
    }
    this.datasetPlantResponses.add(datasetPlantResponse);
  }
