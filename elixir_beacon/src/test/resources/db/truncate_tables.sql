...
TRUNCATE TABLE beacon_data_table CASCADE;
TRUNCATE TABLE beacon_dataset_sample_table CASCADE;
TRUNCATE TABLE beacon_dataset_table CASCADE;
TRUNCATE TABLE beacon_sample_table CASCADE;
