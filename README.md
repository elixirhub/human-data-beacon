...
This modified version is described in the [beacon_plant](https://github.com/ga4gh-beacon/beacon-elixir/blob/beacon_plant_prototype/beacon_plant.md) document.
